$(document).ready(function () {
    ...
    datatable = $('#Books').DataTable({
        ...
        columns: [
            { "data": "id", "name": "Id", "className": "d-none" },
            {
                ...
                "render": function (data, type, row) {
                    return `<div class="symbol symbol-50px overflow-hidden me-3">
                                        <a href="/Books/Details?bkey=${row.bKey}">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="/Books/Details?bkey=${row.bKey}" class="text-primary fw-bolder mb-1">${row.title}</a>
            ...
            { "data": "hall", "name": "Hall" },
            { "data": "categoriesList", "name": "Categories", "orderable": false },
            {
                ...
                "render": function (data, type, row) {
                    return `<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="/Books/Edit?bkey=${row.bKey}" class="menu-link px-3">
                                            Edit
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                                <a href="javascript:;" class="menu-link flex-stack px-3 js-toggle-status" data-url="/Books/ToggleStatus?bkey=${row.bKey}">
                                            Toggle Status
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
